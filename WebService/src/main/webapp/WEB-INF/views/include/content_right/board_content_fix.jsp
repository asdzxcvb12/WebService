		...
		<table style="width: auto">
			...
			<tr align="center">
				<td colspan="3">
					...
					<input type="hidden" id="getBoardCate" name="cateW" value="${cate}">
					<input type="hidden" id="getBoardSubCate" name="subCateW" value="${subCate}">
					<input type="hidden" id="getBoardName" name="boardNameW" value="${boardName}">
